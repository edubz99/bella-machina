...
function autoshowroom_title($atts, $content=null) {
     $autoshowroom_tz_title = $autoshowroom_tz_title1 = $autoshowroom_color_title = $autoshowroom_tz_description =  $autoshowroom_tz_align = $autoshowroom_tz_css_animation = '';
    ...
    ?>
    <div class="autoshowroom-title <?php echo esc_attr($autoshowroom_class);?>">
        <?php
