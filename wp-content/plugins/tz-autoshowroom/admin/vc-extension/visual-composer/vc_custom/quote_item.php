...
<div class="autoshowroom-quote-item <?php echo esc_attr($image_class);?>">
    ...
    <div class="autoshowroom-quote-info">
        <p class="autoshowroom-quote-content"><small>&ldquo;</small><?php echo balanceTags($content);?></p>
    ...
    <div class="autoshowroom-quote-image">
        <div class="autoshowroom-quote-image-box">
            <img width="<?php echo esc_attr($autoshowroom_width_img);?>" height="<?php echo esc_attr($autoshowroom_height_img);?>" alt="<?php echo esc_attr($autoshowroom_name);?>" src="<?php echo esc_url($autoshowroom_url_img);?>">
        </div>
    </div>
<?php } ?>
