                            ...
                            <div class="autoshowroom-blog-item-content">
                                ...
                                <div class="autoshowroom-blog-item-Info">
                                    ...
                                    <?php if($autoshowroom_blog_date == 1):?>
                                        <span><i class="fa fa-calendar"></i><?php echo balanceTags(get_the_date());?></span>
                                        <small>/</small>
                                    <?php endif;?>

                                    <?php if($autoshowroom_blog_comment == 1):?>
                                        <span><i class="fa fa-comment-o"></i></i><?php echo esc_html($autoshowroom_comment_count ->total_comments).' Comments';?></span>
                                        <small>/</small>
                                    <?php endif;?>
                                ...
                                if(!has_post_format('link') && !has_post_format('quote')):
                                    ...
                                    <div class="autoshowroom-blog-item-share">
                                        <i class="fa fa-share-alt"></i><?php esc_html_e(' Share It','autoshowroom')?>
