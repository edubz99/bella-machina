<div class="livedemo">
    ...
    <div class="live-content">
        ...
        <div class="menu_color_item">
            ...
            <div id="colorSelector" class="colorSelector general_color"><div style="background-color: #DAA520"></div></div>
            <div class="clr"></div>
        </div>
        <span class="space">&nbsp;</span>
        <h4>Menu Color</h4>
        ...
        <div class="menu_color_item">
            ...
            <div id="color_menu_hover" class="colorSelector menu_hover"><div style="background-color: #DAA520"></div></div>
        </div>
        <div class="menu_color_item">
        ...
        <div class="menu_color_item">
            ...
            <div id="color_sub_menu_hover" class="colorSelector submenu_hover"><div style="background-color: #DAA520"></div></div>
        </div>
        <div class="menu_color_item">
            <span>Sub-menu Border</span>
            <div id="color_sub_menu_border" class="colorSelector border_submenu"><div style="background-color: #DAA520"></div></div>
        </div>
        <div class="clr"></div>
        <div class="btn_reset">
