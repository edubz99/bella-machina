...
class Car_Dealer_Customs {
	...
	public function __construct() {
		...
		add_filter( 'the_content', array( $this, 'vehicle_content' ) );

		add_filter( 'the_vehicle_content', 'wptexturize' );
		add_filter( 'the_vehicle_content', 'convert_smilies' );
		add_filter( 'the_vehicle_content', 'convert_chars' );
		add_filter( 'the_vehicle_content', 'wpautop' );
		add_filter( 'the_vehicle_content', 'shortcode_unautop' );
		add_filter( 'the_vehicle_content', 'prepend_attachment' );
...
//			$content .= do_shortcode( '[vehicle_gallery]' );
//			$content = apply_filters( 'the_vehicle_content', $content );
		}
