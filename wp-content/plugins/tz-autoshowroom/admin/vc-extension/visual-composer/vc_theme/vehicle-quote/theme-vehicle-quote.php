    ...
    <div class="autoshowroom-vehicle-quote">
        ...
        <div class="vehicle-quote-form">
            <div class="quote-box">
                ...
                <div class="mileage">
                    <label><?php echo esc_html__('Mileage:','tz-autoshowroom'); ?></label>
                    <input type="text" class="quote_mileage" placeholder="25000"/>
                </div>
                <div class="vehicle_date">
                    <label><?php echo esc_html__('Date:','tz-autoshowroom'); ?></label>
            ...
            <div class="info_customer">
                <div class="row">
                    ...
                    <p class="col-md-4"><input class="customer_phone" placeholder="<?php echo esc_html__('Phone','tz-autoshowroom'); ?>"/></p>
