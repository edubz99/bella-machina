...
function autoshowroom_header( $atts )
{
    ...
    $autoshowroom_header = $autoshowroom_sidebar = $autoshowroom_logo_type = $autoshowroom_logo_text =
    ...
    if( $header_class == 'tz-header-1' ) {
        ?>
        <!-- Begin Header 1 -->
        <header class="tz-header <?php echo $autoshowroom_header_menu_cart_true;?>">
            ...
            <div class="tz-menu-header <?php echo $sticky;?>">
                <div class="container tz-megamenu-wrap">
                    <div class="row menu-nav-container">
                        ...
                        <div class="col-md-8 tz-megamenu">
    ...
    elseif ( $header_class == 'tz-header-2' ) {
        ?>
        <!-- Begin Header 2 -->
        <header class="tz-header tz-header-2 <?php echo $autoshowroom_header_menu_cart_true;?>">
    ...
    elseif ( $header_class == 'tz-header-3' ) {
        ?>
        <!-- Begin Header 3 -->
        <header class="tz-header tz-header-3 <?php echo $autoshowroom_header_menu_cart_true;?>">
    ...
    elseif ( $header_class == 'tz-header-4' ) {
        ?>
        <!-- Begin Header 4 -->
        <header class="tz-header tz-header-3 tz-header-4 <?php echo $autoshowroom_header_menu_cart_true;?>">
    ...
    elseif ( $header_class == 'tz-header-5' ) {
        ?>
        <!-- Begin Header 5 -->
        <header class="tz-header tz-header-3 tz-header-5 <?php echo $autoshowroom_header_menu_cart_true;?>">
            <div class="tz-menu-header <?php echo $sticky; ?>">
                <div class="container">
    ...
    elseif( $header_class == 'tz-header-6' ) {
        ?>
        <!-- Begin Header 6 -->
        <header class="tz-header tz-header-6 <?php echo $autoshowroom_header_menu_cart_true;?>">
    ...
    elseif( $header_class == 'tz-header-7' ) {
        ...
        ?>
        <!-- Begin Header 7 -->
        <header class="tz-header tz-header-7 <?php echo $autoshowroom_header_menu_cart_true;?>">
            <?php
                if($autoshowroom_sidebar == 'show'):
            ?>
            <div class="tz-top-header <?php echo esc_attr($header_style_class); ?>">
